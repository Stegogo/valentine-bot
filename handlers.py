...
async def mailing(mess: types.Message):
    if await default_check(types.User.get_current(), admin=True):
        ...
        text = "привіт! У цей складний для нашої країни час є дуже багато людей, які потребують не лише фінансової, а й <b>емоційної допомоги</b>. " \
               ...
               "Але в нього нічого не вийде! Бо ми – сильна нація, ми – Українці! І зараз багато людей потребують моральної підтримки, яку ТИ можеш їм надати. " \
               "Для тебе це кілька слів, а для когось врятований емоційний стан чи навіть життя.\n\n" \
               "Ми розробили бота <a href='https://t.me/UkrMentalSupportBot'>@UkrMentalSupportBot</a>, в якому <b>ти можеш написати</b> або <b>отримати теплі слова підтримки</b>. " \
               "Твої листи будуть надіслані випадковим людям, які мають потребу в лагідних словах.\n\n" \
               "Також ми просимо твоєї допомоги у пошуку таких людей, адже часто ними є твої рідні, друзі чи знайомі. " \
               "А може це підписники в Інстаграмі чи люди з твоїх чатів у Телеграмі.\nПоділися посиланням на бота.\n\nВсе буде Україна🇺🇦🇺🇦🇺🇦"
        succesfull_mails = 0
