...
async def mailing(mess: types.Message):
    if await default_check(types.User.get_current(), admin=True):
        ...
        text = "Привіт! У цей складний для нашої країни час є дуже багато людей, які потребують не лише фінансової, а й словесної допомоги. " \
               ...
               "І зараз багато людей потребують словесної підтримки, яку ти можеш їм дати.  " \
               "Для тебе це кілька слів, а для когось врятована психіка чи навіть життя.  " \
                'Ми розробили <a href="https://t.me/UkrMentalSupportBot">бота</a> @UkrMentalSupportBot, ' \
               "в якому ти можеш написати або отримати листа з теплими словами підтримки." \
               "Твої листи будуть надіслані випадковим людям з тих, хто потребує слів підтримки.  " \
               "Також ми просимо твоєї допомоги у пошуку таких людей, адже часто ними є твої рідні, друзі чи знайомі.  " \
               "А може це підписники в Інстаграмі чи люди з твоїх чатів у Телеграмі.  Поділися з ними посиланням на бота. \nВсе буде Україна🇺🇦🇺🇦🇺🇦!"
        succesfull_mails = 0
